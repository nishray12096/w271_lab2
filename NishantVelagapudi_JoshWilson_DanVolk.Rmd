...
```{r, warning=FALSE}
scatterplotMatrix(data[c("nrel","desired_adj","rosn")])
```
...
#How does adjusted drinking vary by day of week?
ggplot(data = data, aes(x = as.factor(dayweek), y = desired_adj)) + geom_boxplot(aes(fill=factor(dayweek))) + geom_jitter(width=0.1)
