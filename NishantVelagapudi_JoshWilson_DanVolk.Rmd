...
We will also create parallel plots: these help understand how variable values vary in accordance with previous occurences <<<INSERT BETTER EXPLANATION>>>.
```{r}
# Create parallel plots to show relationships between variables
parcoord(data[c('gender','rosn','state','nrel','prel','negevent','posevent','desired', 'numall')],
         col=rgb(0,0,0,alpha=0.05), main="Parallel Coordinates Plot")
parcoord(data[c('gender','rosn','state','nrel','prel','negevent','posevent','desired', 'numall')],
         col=alpha(data$gender+1,0.05), main="Parallel Coordinates Plot")
```
