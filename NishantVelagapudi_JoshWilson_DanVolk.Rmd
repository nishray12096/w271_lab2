...
Josh notes on the above:
1. I'm having trouble intrepreting these plots. It would help to jitter these, alpha, add a trendline.
2. The plots that look meaningful are state and numall. State has a clear positive trend. Numall seems to show a negative trend.
