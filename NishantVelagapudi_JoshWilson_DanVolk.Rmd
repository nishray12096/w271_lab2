...
```{r Boxplots, fig.width=7, fig.height=2.5, fig.show='hold', fig.align='center'}
...
```{r Desired vs Numall, warning = F, messgae = F, fig.width=4, fig.height=2, fig.show='hold', fig.align='center'}
