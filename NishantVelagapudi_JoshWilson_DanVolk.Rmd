...
Looking at the plot above comparing the number of drinks to a Poisson distribution, we see a good fit. This makes sense as we are modeling a count variable as our dependent variable. It will be appropriate moving forward to use Poisson regression analysis.
